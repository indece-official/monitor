...
func (c *Controller) mapReCheckStatusV1ToAPIHostV1Status(reCheckStatuses []*model.ReCheckStatusV1) (*apipublic.HostV1Status, error) {
...
func (c *Controller) mapPgHostV1ToAPIHostV1(pgHost *model.PgHostV1, reCheckStatuses []*model.ReCheckStatusV1) (*apipublic.HostV1, error) {
	...
	apiHostStatus, err := c.mapReCheckStatusV1ToAPIHostV1Status(reCheckStatuses)
	if err != nil {
		return nil, err
	}
...
func (c *Controller) mapPgHostV1ToAPIGetHostsV1ResponseBody(pgHosts []*model.PgHostV1, reCheckStatuses map[string][]*model.ReCheckStatusV1) (*apipublic.V1GetHostsJSONResponseBody, error) {
	resp := &apipublic.V1GetHostsJSONResponseBody{}

	resp.Hosts = []apipublic.HostV1{}

	for _, pgHost := range pgHosts {
		apiHost, err := c.mapPgHostV1ToAPIHostV1(pgHost, reCheckStatuses[pgHost.UID])
		if err != nil {
			return nil, err
		}
...
func (c *Controller) mapPgHostV1ToAPIGetHostV1ResponseBody(pgHost *model.PgHostV1, reCheckStatuses []*model.ReCheckStatusV1) (*apipublic.V1GetHostJSONResponseBody, error) {
	resp := &apipublic.V1GetHostJSONResponseBody{}

	apiHost, err := c.mapPgHostV1ToAPIHostV1(pgHost, reCheckStatuses)
	if err != nil {
		return nil, err
	}
