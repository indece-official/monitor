...
func (s *Service) AddNotifier(qctx context.Context, pgNotifier *model.PgNotifierV1) error {
	...
	if err != nil {
		return fmt.Errorf("can't add notifier '%s': %s", pgNotifier.UID, err)
	}
